Toolbox with Raspberry Pi (on the bottom of the 3rd picture), LCD, relays, fuse and switches:  
...
Added Android Control which communicates over the web interface:
